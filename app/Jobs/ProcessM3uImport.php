            ...
            if ($filePath) {
                ...
                $collection = LazyCollection::make(function () use (
                    ...
                    foreach ($this->m3uParser->parseFile($filePath, max_length: 65536) as $item) {
                        ...
                        // Add 1 adding unique stream_id from m3u file when channel url has stream=number
                        ...
                        if (count($channelGroup) > 0) {
                            foreach ($channelGroup as $chGroup) {
                                ...
                                // Add2 Source_id now includes channel url when url is the only difference, meaning 
